  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        {/* Controle Filtro de Mês */}
        <div className="bg-white p-3 pr-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex items-center gap-5 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all group backdrop-blur-xl">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-50 to-indigo-100/50 text-indigo-600 flex items-center justify-center shadow-inner group-hover:from-indigo-500 group-hover:to-indigo-600 group-hover:text-white transition-all duration-300">
